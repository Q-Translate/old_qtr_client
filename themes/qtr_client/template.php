 ...
 */
function qtr_client_pager_previous($variables) {
 ...
 */
function qtr_client_pager_next($variables) {
 ...
 */
function qtr_client_pager_first($variables) {
 ...
 */
function qtr_client_pager_last($variables) {
